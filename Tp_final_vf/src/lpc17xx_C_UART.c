...
void UART3_IRQHandler(void){
	retardo();			//Para que cargue bien las letras 
	UART_Receive(LPC_UART3,&arraybuffer,sizeof(arraybuffer),NONE_BLOCKING);//Selecciono el UART3, guardo en arraybuffer 
...
/*
 * Retardo para llenar el buffer de receive
 */
void retardo (void){
uint32_t conta;
